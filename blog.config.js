...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '3123dbd8bec0441d912b60cfd69d2705',
  ...
  BIO: '永远相信美好的事情即将发生。', // 作者简介
  LINK: 'https://error0.cn', // 网站地址
  KEYWORDS: 'error0 blog,error0 博客,麦兜博客,技术博客', // 网站关键词 英文逗号隔开
